  ...
  const menuItems: MenuItem[] = [
    {
      ...
      href: '/manufacturer/accounting/createBill',
      type: 'new-bill'
    },
    {
      icon: UserPlus,
      title: "Add New Customer",
      href: '/manufacturer/accounting/addCustomer',
      type: 'new-customer'
    },
    {
      icon: FileInput,
      title: "Customer Invoices",
      href: '/manufacturer/accounting/customerInvoice',
      type: 'invoices'
    },
    {
      icon: Building2,
      title: "Vendor Bills",
      href: '/manufacturer/accounting/vendorBills',
      type: 'vendor-bills'
    },
    {
      icon: Settings,
      title: "Configure Documents",
      href: '/manufacturer/accounting/configureDocuments',
      type: 'configure'
    },
    {
      icon: CreditCard,
      title: "Track Payment",
      href: '/manufacturer/accounting/trackPayment',
      type: 'payments'
    },
  ];
